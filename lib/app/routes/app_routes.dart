...
final List<GoRoute> appRoutes = [
  ...
  GoRoute(path: '/auth/personal', builder: (context, state) => const PersonalAuthScreen()),
  GoRoute(path: '/auth/corporate', builder: (context, state) => const CorporateAuthScreen()),
  GoRoute(path: '/login', builder: (context, state) => const LoginScreen()),
  GoRoute(path: '/register', builder: (context, state) => const RegisterScreen()),
  GoRoute(path: '/mfa-setup', builder: (context, state) => const MFAScreen()),
  GoRoute(path: '/settings/verification', builder: (context, state) => const VerificationScreen()),
  GoRoute(path: '/settings/edit-profile', builder: (context, state) => const EditProfileScreen()),
  GoRoute(
    path: '/order-confirmation/:id',
    builder: (context, state) => OrderConfirmationScreen(productId: state.pathParameters['id']!),
  ),
  GoRoute(
  ...
  GoRoute(
    ...
    builder: (context, state) => MultiStreamScreen(roomId: state.pathParameters['id']!),
  ),
  GoRoute(
    path: '/developer',
    builder: (context, state) => const BotDashboardScreen(appId: 'merope-prime-internal'),
  ),
  GoRoute(
    path: '/enterprise-dashboard',
    builder: (context, state) => const EnterpriseDashboardScreen(appId: 'merope-prime-internal'),
  ),
  GoRoute(path: '/analytics', builder: (context, state) => const AnalyticsDashboard()),
  GoRoute(
    path: '/memory/:id',
    builder: (context, state) => SharedMemoryScreen(memoryId: state.pathParameters['id']!),
  ),
  GoRoute(
    path: '/community/:id',
    builder: (context, state) => CommunityDetailScreen(communityId: state.pathParameters['id']!),
  ),
  GoRoute(
    path: '/collective/:id',
    builder: (context, state) => CollectiveDetailScreen(collectiveId: state.pathParameters['id']!),
  ),
  GoRoute(
    path: '/profile/:id',
  ...
  GoRoute(
    path: '/story/:userId',
    builder: (context, state) => StoriesScreen(userId: state.pathParameters['userId']!),
  ),
  GoRoute(
    path: '/',
