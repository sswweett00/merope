...
class SignalComments extends FamilyAsyncNotifier<List<Map<String, dynamic>>, String> {
  @override
  FutureOr<List<Map<String, dynamic>>> build(String arg) async {
    ...
    return [
      ...
      },
      {
        'id': 'c2',
        'author': 'NodeExplorer',
        'content': 'The synchronization frequency seems slightly off in the third quadrant.',
...
final signalCommentsProvider = AsyncNotifierProviderFamily<SignalComments, List<Map<String, dynamic>>, String>(SignalComments.new);
