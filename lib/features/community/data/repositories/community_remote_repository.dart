...
class ApiCommunityRepository implements ICommunityRepository {
  ...
  Future<String> _userId() async {
    ...
    if (user == null || user.id.trim().isEmpty) {
      throw StateError(
          'An authenticated user is required for community operations');
    }
    return user.id;
  }
  ...
  List<dynamic> _list(dynamic value, [String? key]) {
    ...
    if (value is Map && key != null && value[key] is List)
      return value[key] as List<dynamic>;
    return const <dynamic>[];
  }

  Never _throw(dynamic error) => throw MeropeAPIException.fromDioError(error);

  @override
  Future<List<Community>> getCommunities(
      {int limit = 20, int offset = 0}) async {
    final result = await _apiClient
        .get<dynamic>('/community/communities', queryParameters: {
      'limit': limit,
      'offset': offset,
    });
    return result.fold(
  ...
  Future<Community?> getCommunity(String communityId) async {
    final result =
        await _apiClient.get<dynamic>('/community/communities/$communityId');
    return result.fold(
  ...
  Future<void> createCommunity(Community community) async {
    final result = await _apiClient.post<dynamic>('/community/communities',
  ...
  Future<void> joinCommunity(String communityId) async {
    final result = await _apiClient
        .post<dynamic>('/community/communities/$communityId/join');
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> leaveCommunity(String communityId) async {
    final result = await _apiClient
        .post<dynamic>('/community/communities/$communityId/leave');
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> updateCommunitySettings(
    ...
    final result = await _apiClient.patch<dynamic>(
        '/community/communities/$communityId/settings',
  ...
  Future<void> updateCommunityGuidelines(
    ...
    final result = await _apiClient
        .put<dynamic>('/community/communities/$communityId/guidelines', data: {
  ...
  Future<List<CommunityEvent>> getCommunityEvents(String communityId,
    ...
    final result =
        await _apiClient.get<dynamic>('/community/events', queryParameters: {
      'community_id': communityId,
      'limit': limit,
      'offset': offset,
    });
    return result.fold(
      (data) => _list(data, 'events')
          .map((e) => CommunityEvent.fromJson(_map(e)))
          .toList(growable: false),
      _throw,
    );
  }
  ...
  Future<List<CommunityEvent>> getUpcomingEvents(
      {int limit = 10, int offset = 0}) async {
    final result = await _apiClient
        .get<dynamic>('/community/events/upcoming', queryParameters: {
      'limit': limit,
      'offset': offset,
    });
    return result.fold(
  ...
  Future<void> createEvent(CommunityEvent event) async {
    final result = await _apiClient.post<dynamic>('/community/events',
        data: event.toJson());
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> cancelEvent(String eventId) async {
    final result =
        await _apiClient.delete<dynamic>('/community/events/$eventId');
    result.fold((_) {}, _throw);
  }
  ...
  Future<List<Collective>> getCollectives(
      {int limit = 20, int offset = 0}) async {
    final result = await _apiClient
        .get<dynamic>('/community/collectives', queryParameters: {
      'limit': limit,
      'offset': offset,
    });
    return result.fold(
      (data) => _list(data, 'collectives')
          .map((e) => Collective.fromJson(_map(e)))
          .toList(growable: false),
      _throw,
    );
  }
  ...
  Future<void> createCollective(Collective collective) async {
    final result = await _apiClient.post<dynamic>('/community/collectives',
        data: collective.toJson());
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> joinCollective(String collectiveId) async {
    final result = await _apiClient
        .post<dynamic>('/community/collectives/$collectiveId/join');
    result.fold((_) {}, _throw);
  }
  ...
  Future<List<CollectiveThread>> getThreads(String collectiveId,
    ...
    final result = await _apiClient.get<dynamic>(
        '/community/collectives/$collectiveId/threads',
        queryParameters: {
          'limit': limit,
          'offset': offset,
        });
    return result.fold(
      (data) => _list(data, 'threads')
          .map((e) => CollectiveThread.fromJson(_map(e)))
          .toList(growable: false),
      _throw,
    );
  }
  ...
  Future<void> createThread(CollectiveThread thread) async {
    final result = await _apiClient.post<dynamic>(
        '/community/collectives/${thread.collectiveId}/threads',
        data: thread.toJson());
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> resonateThread(String threadId, int delta) async {
    final result = await _apiClient.post<dynamic>(
        '/community/threads/$threadId/resonate',
        data: {'delta': delta});
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> createThreadReply(ThreadReply reply) async {
    final result = await _apiClient.post<dynamic>(
        '/community/threads/${reply.threadId}/replies',
        data: reply.toJson());
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> lockThread(String threadId, bool locked) async {
    final result = await _apiClient.post<dynamic>(
        '/community/threads/$threadId/lock',
        data: {'locked': locked});
    result.fold((_) {}, _throw);
  }
  ...
  Future<List<CommunityMember>> getCommunityMembers(String communityId,
    ...
    return result.fold(
      (data) => _list(data, 'members')
          .map((e) => CommunityMember.fromJson(_map(e)))
          .toList(growable: false),
      _throw,
    );
  }
  ...
  Future<void> updateMemberRole(
    ...
    final result = await _apiClient.patch<dynamic>(
        '/community/communities/$communityId/members/$memberId',
        data: {'role': role});
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> banMember(
    ...
    final result = await _apiClient.post<dynamic>(
        '/community/communities/$communityId/members/$memberId/ban',
        data: {'reason': reason});
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> unbanMember(String communityId, String memberId) async {
    final result = await _apiClient.post<dynamic>(
        '/community/communities/$communityId/members/$memberId/unban');
    result.fold((_) {}, _throw);
  }
  ...
  Future<List<Subscription>> getUserSubscriptions() async {
    ...
    final result = await _apiClient.get<dynamic>('/community/subscriptions',
        queryParameters: {'user_id': userId});
    return result.fold(
      (data) => _list(data, 'subscriptions')
          .map((e) => Subscription.fromJson(_map(e)))
          .toList(growable: false),
      _throw,
    );
  }
  ...
  Future<void> createSubscription(String creatorId, String tier) async {
    final result = await _apiClient.post<dynamic>('/community/subscriptions',
        data: {'creator_id': creatorId, 'tier': tier});
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> cancelSubscription(String subscriptionId) async {
    final result = await _apiClient
        .delete<dynamic>('/community/subscriptions/$subscriptionId');
    result.fold((_) {}, _throw);
  }
  ...
  Future<void> updateSubscriptionTier(
    ...
    final result = await _apiClient.patch<dynamic>(
        '/community/subscriptions/$subscriptionId',
        data: {'tier': tier});
    result.fold((_) {}, _throw);
  }
  ...
  Future<CommunityAnalytics?> getCommunityAnalytics(
    ...
    final result = await _apiClient.get<dynamic>(
        '/community/communities/$communityId/analytics',
