...
final developerMetricsProvider = StreamProvider.family<DeveloperMetrics, String>((ref, appId) {
  ...
  final localStream = local.watchMetrics(appId, 'realtime').map((points) => DeveloperMetrics(
        appId: appId,
        period: 'realtime',
        dataPoints: points,
      ));
