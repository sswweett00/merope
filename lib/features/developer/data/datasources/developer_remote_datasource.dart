...
abstract class DeveloperRemoteDataSource {
  ...
  Future<DeveloperApp> createApp(String ownerId, String name, String? description);
  ...
  Future<ApiKey> createApiKey(String appId, String name, String? description, List<String> scopes, int ttlDays);
  ...
  Future<Webhook> createWebhook(String appId, String name, String url, List<String> events);
...
class DeveloperRemoteDataSourceImpl implements DeveloperRemoteDataSource {
  ...
  Future<List<DeveloperApp>> getApps(String ownerId) async {
    final result = await _apiClient.get<List<dynamic>>('/developer/apps', queryParameters: {'owner_id': ownerId});
    return result.fold(
      (data) => (data ?? []).map((e) => DeveloperApp.fromJson(Map<String, dynamic>.from(e))).toList(),
  ...
  Future<DeveloperApp?> getApp(String appId) async {
    final result = await _apiClient.get<Map<String, dynamic>>('/developer/apps/$appId');
    return result.fold(
  ...
  Future<DeveloperApp> createApp(String ownerId, String name, String? description) async {
    final result = await _apiClient.post<Map<String, dynamic>>('/developer/apps', data: {
      'owner_id': ownerId,
      'name': name,
  ...
  Future<DeveloperApp> updateApp(DeveloperApp app) async {
    final result = await _apiClient.put<Map<String, dynamic>>('/developer/apps/${app.id}', data: app.toJson());
    return result.fold(
      (data) => DeveloperApp.fromJson(data!),
      (error) => throw MeropeAPIException.fromDioError(error),
    );
  ...
  Future<List<ApiKey>> getApiKeys(String appId) async {
    final result = await _apiClient.get<Map<String, dynamic>>('/developer/apps/$appId/api-keys');
    return result.fold(
      (data) => (data?['keys'] as List<dynamic>? ?? []).map((e) => ApiKey.fromJson(Map<String, dynamic>.from(e))).toList(),
      (error) => throw MeropeAPIException.fromDioError(error),
    );
  }
  ...
  Future<ApiKey?> getApiKey(String keyId) async {
    final result = await _apiClient.get<Map<String, dynamic>>('/developer/api-keys/$keyId');
    return result.fold(
  ...
  Future<ApiKey> createApiKey(String appId, String name, String? description, List<String> scopes, int ttlDays) async {
    final result = await _apiClient.post<Map<String, dynamic>>('/developer/apps/$appId/api-keys', data: {
      'name': name,
      if (description != null) 'description': description,
      'scopes': scopes,
      'ttl_days': ttlDays,
  ...
  Future<ApiKey> updateApiKey(ApiKey key) async {
    final result = await _apiClient.put<Map<String, dynamic>>('/developer/api-keys/${key.id}', data: key.toJson());
    return result.fold(
      (data) => ApiKey.fromJson(data!),
      (error) => throw MeropeAPIException.fromDioError(error),
    );
  ...
  Future<List<Webhook>> getWebhooks(String appId) async {
    final result = await _apiClient.get<Map<String, dynamic>>('/developer/apps/$appId/webhooks');
    return result.fold(
      (data) => (data?['webhooks'] as List<dynamic>? ?? []).map((e) => Webhook.fromJson(Map<String, dynamic>.from(e))).toList(),
      (error) => throw MeropeAPIException.fromDioError(error),
    );
  }
  ...
  Future<Webhook?> getWebhook(String webhookId) async {
    final result = await _apiClient.get<Map<String, dynamic>>('/developer/webhooks/$webhookId');
    return result.fold(
  ...
  Future<Webhook> createWebhook(String appId, String name, String url, List<String> events) async {
    final result = await _apiClient.post<Map<String, dynamic>>('/developer/apps/$appId/webhooks', data: {
      'name': name,
      'url': url,
      'events': events,
    });
  ...
  Future<Webhook> updateWebhook(Webhook webhook) async {
    final result = await _apiClient.put<Map<String, dynamic>>('/developer/webhooks/${webhook.id}', data: webhook.toJson());
    return result.fold(
      (data) => Webhook.fromJson(data!),
      (error) => throw MeropeAPIException.fromDioError(error),
    );
  ...
  Future<void> deleteWebhook(String webhookId) async {
    final result = await _apiClient.delete<void>('/developer/webhooks/$webhookId');
    result.fold(
      (_) {},
      (error) => throw MeropeAPIException.fromDioError(error),
    );
  ...
  Future<void> testWebhook(String webhookId) async {
    final result = await _apiClient.post<void>('/developer/webhooks/$webhookId/test', data: {});
    result.fold(
      (_) {},
      (error) => throw MeropeAPIException.fromDioError(error),
    );
  ...
  Future<List<Bot>> getBots(String appId) async {
    final result = await _apiClient.get<List<dynamic>>('/developer/apps/$appId/bots');
    return result.fold(
      (data) => (data ?? []).map((e) => Bot.fromJson(Map<String, dynamic>.from(e))).toList(),
      (error) => throw MeropeAPIException.fromDioError(error),
    );
  }
  ...
  Future<Bot?> getBot(String botId) async {
    final result = await _apiClient.get<Map<String, dynamic>>('/developer/bots/$botId');
    return result.fold(
  ...
  Future<Bot> createBot(String appId, String name, String? description) async {
    final result = await _apiClient.post<Map<String, dynamic>>('/developer/apps/$appId/bots', data: {
      'name': name,
      if (description != null) 'description': description,
    });
    return result.fold(
  ...
  Future<Bot> updateBot(Bot bot) async {
    final result = await _apiClient.put<Map<String, dynamic>>('/developer/bots/${bot.id}', data: bot.toJson());
    return result.fold(
      (data) => Bot.fromJson(data!),
      (error) => throw MeropeAPIException.fromDioError(error),
    );
  ...
  Future<DeveloperMetrics> getMetrics(String appId, String period) async {
    final result = await _apiClient.get<Map<String, dynamic>>('/developer/apps/$appId/metrics', queryParameters: {'period': period});
    return result.fold(
  ...
  Future<TestSuiteResult> runTestSuite(String appId) async {
    final result = await _apiClient.post<Map<String, dynamic>>('/developer/apps/$appId/test-suite');
    return result.fold(
