...
enum WorkspaceLayer {
  ...
  String get label {
    switch (this) {
      case WorkspaceLayer.personal: return 'Personal';
      case WorkspaceLayer.work: return 'Work';
      case WorkspaceLayer.finance: return 'Finance';
    }
  }

  IconData get icon {
    switch (this) {
      case WorkspaceLayer.personal: return Icons.person_rounded;
      case WorkspaceLayer.work: return Icons.work_rounded;
      case WorkspaceLayer.finance: return Icons.account_balance_wallet_rounded;
    }
  }

  Color get accentColor {
    switch (this) {
      case WorkspaceLayer.personal: return const Color(0xFF5865F2);
      case WorkspaceLayer.work: return const Color(0xFF3BA55D);
      case WorkspaceLayer.finance: return const Color(0xFFF0B232);
    }
  }
}
...
final workspaceProvider = NotifierProvider<WorkspaceController, WorkspaceLayer>(WorkspaceController.new);

final workspaceThemeProvider = Provider<MeropeColorTokens>((ref) {
  final layer = ref.watch(workspaceProvider);
  final baseTokens = MeropeColorTokens.darkDefault(); // Assume dark for now or watch themeProvider
