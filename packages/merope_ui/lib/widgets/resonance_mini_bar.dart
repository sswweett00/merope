...
import 'package:merope_ui/widgets/resonance_player_screen.dart';

class ResonanceMiniBar extends ConsumerWidget {
  const ResonanceMiniBar({super.key});
    ...
    return GestureDetector(
      onTap: () {
        showModalBottomSheet(
          ...
          builder: (context) => const ResonancePlayerScreen(),
        );
      },
      child: Container(
          ...
          children: [
            ClipRRect(
              ...
              child: Container(
                ...
                child: Icon(Icons.waves, color: tokens.primary),
              ),
            ),
            ...
            IconButton(
              icon: Icon(Icons.fast_forward, color: tokens.textPrimary),
              onPressed: () {
