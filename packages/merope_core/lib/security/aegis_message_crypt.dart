...
class AegisMessageCryptNotifier extends AsyncNotifier<void> {
  ...
  Future<String?> decrypt(String conversationId, AegisEncryptedPayload payload) async {
    return await AegisMessageCrypt.decrypt(conversationId, payload);
  }

  Future<void> decryptAndBuffer(String conversationId, AegisEncryptedPayload payload) async {
...
final aegisMessageCryptProvider =
    AsyncNotifierProvider<AegisMessageCryptNotifier, void>(AegisMessageCryptNotifier.new);
...
class AegisMessageCrypt {
  ...
  static Future<AegisEncryptedPayload> encrypt(String conversationId, String plaintext) async {
  ...
  static Future<void> decryptAndBuffer(String conversationId, AegisEncryptedPayload payload) async {
  ...
  static Future<String?> decrypt(String conversationId, AegisEncryptedPayload payload) async {
...
class AegisEncryptedPayload {
  ...
  factory AegisEncryptedPayload.fromJson(Map<String, dynamic> json) => AegisEncryptedPayload(
    ciphertextHex: json['ciphertext'] as String? ?? json['ciphertextHex'] as String? ?? '',
  );
